...
export const MicrophoneIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
    <path fillRule="evenodd" d="M7 4a3 3 0 016 0v4a3 3 0 11-6 0V4zm5 10.5a.5.5 0 00.5.5h.5a.5.5 0 00.5-.5v-1.5a.5.5 0 00-.5-.5h-.5a.5.5 0 00-.5.5v1.5zM12 11a.5.5 0 00-.5.5v1.5a.5.5 0 00.5.5h.5a.5.5 0 00.5-.5v-1.5a.5.5 0 00-.5-.5h-.5zM8 11a.5.5 0 00-.5.5v1.5a.5.5 0 00.5.5h.5a.5.5 0 00.5-.5v-1.5a.5.5 0 00-.5-.5h-.5zM7.5 13a.5.5 0 00.5.5h.5a.5.5 0 00.5-.5v-1.5a.5.5 0 00-.5-.5h-.5a.5.5 0 00-.5.5v1.5zM10 18a8 8 0 100-16 8 8 0 000 16z" clipRule="evenodd" />
  </svg>
);
...
export const UserCircleIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-full w-full text-gray-600 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
...
export const UserPlusIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 11h-4m2-2v4" />
    </svg>
);
